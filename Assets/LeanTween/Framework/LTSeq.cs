...
//		Debug.Log("delay:"+delay+" count:"+this.current.count+" this.current.totalDelay:"+this.current.totalDelay);
	...
	/**
	* Add a timeUI delay to the sequence
	* @method append (delay)
	* @param {float} delay:float healAndDamageAmount of timeUI to add to the sequence
...
//			Debug.Log("seq.count:" + count + " seq.tween:" + seq.tween);
			...
			if (seq.tween != null) {
//			Debug.Log("seq.tween.timeUI * timeScale:" + seq.tween.timeUI * timeScale + " seq.totalDelay:"+seq.totalDelay +" timeUI:"+seq.tween.timeUI+" seq.tween.delay:"+seq.tween.delay);
