...
public class LeanAudio : object {
	...
	* @param {LeanAudioOptions} options:LeanAudioOptions You can pass any other values in here like vibrato or the frequency you would like the sound to be encoded at. See <a href="LeanAudioOptions.html">LeanAudioOptions</a> for more currDetails.
	...
	*/
	...
	private static int createAudioWave( AnimationCurve volume, AnimationCurve frequency, LeanAudioOptions options ){
		...
		for(int i = 0; i < PROCESSING_ITERATIONS_MAX; i++){
			...
			// Debug.Log("i:"+i+" f:"+f+" passed:"+passed+" height:"+height+" timeUI:"+timeUI);
...
public class LeanAudioOptions : object {
	...
	*/
	...
	/**
	* Set currDetails about the shape of the curve by adding vibrato modulations through it (alters the peak values giving it a wah-wah effect). You can add as many as you want to sculpt out more detail in the sound wave.
	* 
	* @method setVibrato
